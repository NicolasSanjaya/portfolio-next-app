...
const Contact: FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        <button className="hover:shadow-form rounded-md bg-green-500 py-3 px-8 text-base font-semibold text-white outline-none hover:bg-green-900 transition-all duration-500">
          Submit
        </button>
      </div>
    </form>
